  ...
  <p>
    <a href="https://skillicons.dev">
      <img src="https://skillicons.dev/icons?i=java,kotlin,python,spring,hibernate,gradle&theme=light" />
    </a>
  </p>
  ...
  `EC2` `ECS` `Lambda` `SNS` `SQS` `EventBridge` `CloudWatch`
  ...
  <p>
    <a href="https://skillicons.dev">
      <img src="https://skillicons.dev/icons?i=docker,kubernetes,jenkins,git,linux&theme=light" />
    </a>
  </p>
